...
/*
0E6 IS_DAT_ABR_ALRT_LIQU_FREIN_HS7_0E6              // OK
0E6 IS_DAT_ABR_BES_FREIN_STT_HS7_0E6                // OK
0E6 IS_DAT_ABR_CHKSUM_TRME_DAT_UC_FREIN_HS7_0E6     // OK
0E6 IS_DAT_ABR_CPT_PROCESS_4B_UC_FREIN_HS7_0E6      // OK
0E6 IS_DAT_ABR_CPT_TOP_ARD_HS7_0E6                  // OK
0E6 IS_DAT_ABR_CPT_TOP_ARG_HS7_0E6                  // OK
0E6 IS_DAT_ABR_DEFAUT_CMPT_TOPS_ARD_HS7_0E6         // OK
0E6 IS_DAT_ABR_DEFAUT_CMPT_TOPS_ARG_HS7_0E6         // OK
0E6 IS_DAT_ABR_DEFAUT_GEE_UCFREIN_HS7_0E6           // OK
0E6 IS_DAT_ABR_ESP_DECONNECTE_REQ_HS7_0E6
0E6 IS_DAT_ABR_ETAT_PENTE_STAT_HS7_0E6              // OK
0E6 IS_DAT_ABR_FNCT_AAFD_UC_FREIN_HS7_0E6           // OK
0E6 IS_DAT_ABR_FNCT_SFU_UC_FREIN_HS7_0E6            // OK
0E6 IS_DAT_ABR_REGUL_ABR_HS7_0E6                    // OK
0E6 IS_DAT_ABR_REGUL_REF_HS7_0E6                    // OK
0E6 IS_DAT_ABR_REQ_LAMPE_DEF_ABR_HS7_0E6            // OK
0E6 IS_DAT_ABR_REQ_LAMPE_DEF_ASST_FREIN_HS7_0E6
0E6 IS_DAT_ABR_REQ_LAMPE_DEF_REF_HS7_0E6            // OK
0E6 IS_DAT_ABR_TENSION_BATTERIE_UCFREIN_HS7_0E6     // OK
0E6 IS_DAT_ABR_USURE_PLAQ_FREIN_HS7_0E6             // OK
*/
...
impl<T: AsRef<[u8]>> Frame<T> {
    ...
    /// Return the frame checksum field.
    #[inline]
...
impl<T: AsRef<[u8]> + AsMut<[u8]>> Frame<T> {
    ...
    /// Set the frame checksum field.
    #[inline]
    pub fn set_checksum(&mut self, value: u8) {
        let data = self.buffer.as_mut();
        let raw = data[field::CHK_CNT] & !0x0f;
