...
impl<T: AsRef<[u8]>> Frame<T> {
    ...
    #[inline]
    pub fn user_action_on_mfd(&self) -> UserAction {
        let data = self.buffer.as_ref();
...
impl<T: AsRef<[u8]> + AsMut<[u8]>> Frame<T> {
    ...
    #[inline]
    pub fn set_user_action_on_mfd(&mut self, value: UserAction) {
        let data = self.buffer.as_mut();
...
mod test {
    ...
    fn frame_1_repr() -> Repr {
        Repr {
            ...
            user_action_on_mfd: UserAction::NoAction,
            user_value: 0,
        }
    }
    ...
    fn test_frame_1_deconstruction() {
        ...
        assert_eq!(frame.user_action_on_mfd(), UserAction::NoAction);
    ...
    fn test_frame_1_construction() {
        ...
        frame.set_user_action_on_mfd(UserAction::NoAction);
