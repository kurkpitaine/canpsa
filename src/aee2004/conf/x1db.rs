...
/// Raw x1db CAN frame identifier.
pub const FRAME_ID: u16 = 0x1db;
/// Length of a x1db CAN frame.
...
/// A high-level representation of a x1db CAN frame.
...
impl Repr {
    ...
    /// Emit a high-level representation into a x1db CAN frame.
